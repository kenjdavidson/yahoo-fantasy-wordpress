...
/**
 * Globals and utilities for OAuth Examples package
 *
 * Globals functions provided by Joe Chung
 * @ https://github.com/joechung/oauth_yahoo
 *
 * Required due to the PECL OAuth library not refreshing access token.
 */
$progname = 'Yahoo_OAuth';
