...
/**
 * The code that runs during plug-in activation.  Activation code calls the
 * static Yahoo_Fantasy_Activator::activate() method.  Currently there is
 * nothing that needs to be done during activation.
 * 
 * This action is documented in includes/class-plug-in-name-activator.php
 */
...
/**
 * The code that runs during plug-in deactivation.  Deactivation needs to clear
 * out any options that were previously created.
 * This action is documented in includes/class-plug-in-name-deactivator.php
 */
...
/**
 * The core plug-in class that is used to define internationalization,
 * administration specific hooks, and public-facing site hooks.
 */
